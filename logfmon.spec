...
after a final message is found or a number of messages is reached. 
See logfmon.conf(5) for more details of this.

%description -l pl
Demon logfmon monitoruje zestaw plików sysloga i porównuje ka¿dy
nowy wpis z regu³ami zdefiniowanymi w swoim pliku konfiguracyjnym.
Ka¿da regu³a mo¿e byæ porównywana z lini± z jednego lub wielu
plików. W zale¿no¶ci od regu³y mo¿e byæ wykonywana komenda lub wpis
mo¿e byæ ignorowany. Wszystkie niedopasowane linie s± zbierane i
